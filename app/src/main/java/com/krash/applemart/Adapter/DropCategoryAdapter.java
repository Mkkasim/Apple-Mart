...
public class DropCategoryAdapter extends RecyclerView.Adapter<DropCategoryAdapter.ViewHolder> {
    ...
    public DropCategoryAdapter(Context context, ArrayList<ItemInHomeModel> list, OnItemClickListener itemClickListener) {
