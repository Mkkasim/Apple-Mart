...
public class VariantProductAdapter extends RecyclerView.Adapter<VariantProductAdapter.ViewHolder> {
    ...
    public VariantProductAdapter(Context context, ArrayList<FruitsVegetablesModel> list, OnItemClickListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_variants_products,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            variantImg = itemView.findViewById(R.id.variantImg);
