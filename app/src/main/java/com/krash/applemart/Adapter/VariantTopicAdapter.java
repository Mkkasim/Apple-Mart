...
public class VariantTopicAdapter extends RecyclerView.Adapter<VariantTopicAdapter.ViewHolder> {

    Context context;
    private ArrayList<ItemInHomeModel> list;
    private OnItemClickListener itemClickListener;

    public VariantTopicAdapter(Context context, ArrayList<ItemInHomeModel> list, OnItemClickListener itemClickListener) {
